...
async function searchPredictions(payload) {
...
"[project]/src/components/dashboard/TrafficMap.jsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function TrafficMap() {
    _s();
    const [activeLayer, setActiveLayer] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("live");
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "TrafficMap.useEffect": ()=>{
            let mounted = true;
            const load = {
                "TrafficMap.useEffect.load": async ()=>{
                    setLoading(true);
                    try {
                        ...
                        if (!mounted) return;
                        setSegments(segData || []);
                        const merged = (hotspotData || []).map({
                            "TrafficMap.useEffect.load.merged": (h)=>{
                                const match = segData?.find({
                                    "TrafficMap.useEffect.load.merged": (s)=>s.road_id === h.road_id
                                }["TrafficMap.useEffect.load.merged"]);
                                return {
                                    ...h,
                                    lat: match?.lat,
                                    lon: match?.lon,
                        ...
                        }["TrafficMap.useEffect.load.merged"]).filter({
                            "TrafficMap.useEffect.load.merged": (h)=>h.lat != null && h.lon != null
                        }["TrafficMap.useEffect.load.merged"]);
                        setHotspots(merged);
                        setError("");
                    } catch (err) {
    ...
    const bounds = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "TrafficMap.useMemo[bounds]": ()=>{
            if (!hotspots.length) return null;
            const lats = hotspots.map({
                "TrafficMap.useMemo[bounds].lats": (h)=>h.lat
            }["TrafficMap.useMemo[bounds].lats"]).filter({
                "TrafficMap.useMemo[bounds].lats": (v)=>v != null
            }["TrafficMap.useMemo[bounds].lats"]);
            const lons = hotspots.map({
                "TrafficMap.useMemo[bounds].lons": (h)=>h.lon
            }["TrafficMap.useMemo[bounds].lons"]).filter({
                "TrafficMap.useMemo[bounds].lons": (v)=>v != null
            }["TrafficMap.useMemo[bounds].lons"]);
            return {
    ...
    const filteredHotspots = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "TrafficMap.useMemo[filteredHotspots]": ()=>{
            const bySearch = hotspots.filter({
                "TrafficMap.useMemo[filteredHotspots].bySearch": (h)=>{
                    if (!searchQuery) return true;
                    const hay = `${h.road_name || ""} ${h.segment_name || ""} ${h.road_id || ""}`.toLowerCase();
                    return hay.includes(searchQuery.toLowerCase());
                }
            }["TrafficMap.useMemo[filteredHotspots].bySearch"]);
            if (activeLayer === "accidents") return bySearch.filter({
                "TrafficMap.useMemo[filteredHotspots]": (h)=>(h.congestion_pct || 0) >= 80
            }["TrafficMap.useMemo[filteredHotspots]"]);
            if (activeLayer === "heatmap") return bySearch.filter({
                "TrafficMap.useMemo[filteredHotspots]": (h)=>(h.congestion_pct || 0) >= 60
            }["TrafficMap.useMemo[filteredHotspots]"]);
            return bySearch;
        }
    }["TrafficMap.useMemo[filteredHotspots]"], [
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "relative w-full h-[600px] bg-slate-950 rounded-xl border border-border overflow-hidden group",
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                fileName: "[project]/src/components/dashboard/TrafficMap.jsx",
                lineNumber: 105,
                columnNumber: 13
            }, this),
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "absolute top-6 left-6 z-20 w-80",
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("form", {
                    ...
                    children: [
                        ...
                        isSearching && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            className: "absolute right-3 top-1/2 -translate-y-1/2 w-4 h-4 rounded-full border-2 border-primary border-t-transparent animate-spin"
                        }, void 0, false, {
                            fileName: "[project]/src/components/dashboard/TrafficMap.jsx",
                            lineNumber: 119,
                            columnNumber: 25
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$components$2f$AnimatePresence$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AnimatePresence"], {
                        children: filteredHotspots.map((spot)=>{
                            ...
                            return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$render$2f$components$2f$motion$2f$proxy$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["motion"].div, {
                                ...
                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("absolute -inset-3 rounded-full animate-ping", meta.glow)
                                        }, void 0, false, {
                                            fileName: "[project]/src/components/dashboard/TrafficMap.jsx",
                                            lineNumber: 142,
                                            columnNumber: 37
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("relative bg-background p-1.5 rounded-full border shadow-lg", meta.iconColor, meta.color),
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            className: "absolute bottom-full mb-2 left-1/2 -translate-x-1/2 bg-popover text-popover-foreground text-xs px-2 py-1 rounded border border-border whitespace-nowrap opacity-0 group-hover/marker:opacity-100 transition-opacity",
                                            children: [
                                                spot.segment_name || spot.road_name || spot.road_id,
                                                " · ",
                                                Math.round(spot.congestion_pct || 0),
                                                "% (",
                                                meta.label,
                                                ")"
                                            ]
                            ...
                            }, `${spot.road_id}-${spot.timestamp}`, false, {
                                fileName: "[project]/src/components/dashboard/TrafficMap.jsx",
                                lineNumber: 133,
                                columnNumber: 29
                            }, this);
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        className: "absolute -inset-4 bg-primary/20 blur-xl rounded-full animate-pulse"
                                    }, void 0, false, {
                                        fileName: "[project]/src/components/dashboard/TrafficMap.jsx",
                                        lineNumber: 157,
                                        columnNumber: 25
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$map$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Map$3e$__["Map"], {
                                        className: "w-16 h-16 text-primary relative z-10 mx-auto"
                                    }, void 0, false, {
                                        fileName: "[project]/src/components/dashboard/TrafficMap.jsx",
                                        lineNumber: 158,
                                        columnNumber: 25
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h3", {
                                className: "text-2xl font-bold bg-clip-text text-transparent bg-gradient-to-b from-white to-white/60",
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                        ...
                                        children: "(Spatial layout simulated; swap with Mapbox/Leaflet when ready)"
                                    }, void 0, false, {
                                        fileName: "[project]/src/components/dashboard/TrafficMap.jsx",
                                        lineNumber: 166,
                                        columnNumber: 25
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(MapControl, {
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(MapControl, {
                        ...
                        label: "Accidents",
                        active: activeLayer === "accidents",
                        onClick: ()=>setActiveLayer("accidents")
                    }, void 0, false, {
                        fileName: "[project]/src/components/dashboard/TrafficMap.jsx",
                        lineNumber: 176,
                        columnNumber: 17
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "absolute bottom-0 left-0 right-0 h-10 bg-background/80 backdrop-blur-md border-t border-border flex items-center px-4 text-xs font-mono text-muted-foreground z-20",
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(Corner, {
                className: "top-0 left-0 border-t border-l rounded-tl-xl"
            }, void 0, false, {
                fileName: "[project]/src/components/dashboard/TrafficMap.jsx",
                lineNumber: 193,
                columnNumber: 13
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(Corner, {
                className: "top-0 right-0 border-t border-r rounded-tr-xl"
            }, void 0, false, {
                fileName: "[project]/src/components/dashboard/TrafficMap.jsx",
                lineNumber: 194,
                columnNumber: 13
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(Corner, {
                className: "bottom-0 left-0 border-b border-l rounded-bl-xl"
            }, void 0, false, {
                fileName: "[project]/src/components/dashboard/TrafficMap.jsx",
                lineNumber: 195,
                columnNumber: 13
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(Corner, {
                className: "bottom-0 right-0 border-b border-r rounded-br-xl"
            }, void 0, false, {
                fileName: "[project]/src/components/dashboard/TrafficMap.jsx",
                lineNumber: 196,
                columnNumber: 13
...
_s(TrafficMap, "nOfJa3z2l7P86151tEinscREQXg=");
_c = TrafficMap;
function MapControl({ icon, active, onClick, label }) {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
        onClick: onClick,
        className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("p-2 rounded-lg backdrop-blur-md border transition-all duration-200 flex items-center gap-2 pr-4 group/btn", active ? "bg-primary/20 border-primary text-primary shadow-[0_0_15px_rgba(var(--primary),0.5)]" : "bg-card/40 border-border text-muted-foreground hover:bg-card/60 hover:text-white"),
        children: [
            icon,
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("text-xs font-medium transition-all duration-300 w-0 overflow-hidden opacity-0 group-hover/btn:w-auto group-hover/btn:opacity-100", active && "w-auto opacity-100"),
                children: label
            }, void 0, false, {
                fileName: "[project]/src/components/dashboard/TrafficMap.jsx",
                lineNumber: 213,
...
function Corner({ className }) {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("absolute w-4 h-4 border-primary/50", className)
    }, void 0, false, {
        fileName: "[project]/src/components/dashboard/TrafficMap.jsx",
        lineNumber: 222,
        columnNumber: 9
...
__turbopack_context__.k.register(_c1, "MapControl");
__turbopack_context__.k.register(_c2, "Corner");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$dashboard$2f$TrafficMap$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/dashboard/TrafficMap.jsx [app-client] (ecmascript)");
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(LeafletMap, {}, void 0, false, {
                                        fileName: "[project]/src/app/map/page.js",
                                        lineNumber: 33,
                                        columnNumber: 29
                                    }, this)
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$dashboard$2f$TrafficMap$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TrafficMap"], {}, void 0, false, {
                                            fileName: "[project]/src/app/map/page.js",
                                            lineNumber: 38,
                                            columnNumber: 29
                                        }, this),
...
//# sourceMappingURL=src_e912d272._.js.map