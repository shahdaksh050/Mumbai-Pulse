...
const API_BASE = (__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.NEXT_PUBLIC_API_BASE || __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.API_BASE_URL || "").replace(/\/$/, "");
...
function MapPage() {
    ...
    const combinedSegments = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "MapPage.useMemo[combinedSegments]": ()=>{
            return segments.map({
                "MapPage.useMemo[combinedSegments]": (seg)=>{
            ...
            }["MapPage.useMemo[combinedSegments]"]).sort({
                "MapPage.useMemo[combinedSegments]": (a, b)=>(b.congestion_pct ?? 0) - (a.congestion_pct ?? 0)
            }["MapPage.useMemo[combinedSegments]"]);
        }
    }["MapPage.useMemo[combinedSegments]"], [
        segments,
    ...
    const filtered = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "MapPage.useMemo[filtered]": ()=>{
            ...
            return combinedSegments.filter({
                "MapPage.useMemo[filtered]": (item)=>{
    ...
    const colorFor = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "MapPage.useCallback[colorFor]": (pct)=>{
    ...
    const markers = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "MapPage.useMemo[markers]": ()=>{
            return filtered.map({
                "MapPage.useMemo[markers]": (item, idx)=>{
...
_s(MapPage, "fkJU4MfzkKJVzbShc+BPmO0us+g=", false, function() {
    return [
        useTrafficData
    ];
});
...
//# sourceMappingURL=src_17bb5b4a._.js.map